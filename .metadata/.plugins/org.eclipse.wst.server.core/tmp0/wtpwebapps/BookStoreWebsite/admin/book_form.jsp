		...
		<table class="form">
			...
			<tr>
				...
				<td align="left">
					...
					<img id="thumbnail" alt="Image Preview" style="width:20%; margine-top:10px" 
			...
			<tr>
				...
				<td align="left">
					<textarea rows="5" cols="50" name="description" id="description" >${book.descripton}</textarea>
				</td>
			</tr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#publishDate").datepicker({ showAnim: 'slideDown' });
